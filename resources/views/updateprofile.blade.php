...
<html lang="en">
  ...
  <style>
    ...
    .btn-purple {
        background-color: #800080; /* Use the desired shade of purple */
...
<div class="container">
  <div class="edit-profile-container">
    ...
    <form onsubmit="return validateForm()" id="profileForm" action="{{ route('updatesave') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <!-- Hidden file input outside the visible area -->
<!-- Replace your existing file input -->
        <img src="{{ asset('storage/uploads/' . $user->image_path) }}" alt="Profile Picture" class="profile-pic" id="profilePic" name="profilePic" value="{{ asset('storage/uploads/' . $user->image_path) }}">
        ...
        <div class="form-group">
            <div class="row">
              <div class="col">
                ...
                <input type="text" class="form-control" id="fname" name="fname" placeholder="First Name" value="{{ $user->first_name }} ">
                <span id="fnameError" class="error-text"></span>
              </div>
              <div class="col">
                <label for="lname">Last Name</label>
                <input type="text" class="form-control" id="lname" name="lname" placeholder="Last Name" value="{{ $user->last_name }}" >
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="contactNo" name="contactNo" placeholder="Contact No" value="{{ $user->phone }}" >
...
<script>
  ...
  // Attach the showAlert function to the form's onsubmit event
